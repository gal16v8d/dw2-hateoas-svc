...
class DigimonTypeServiceIT {
    ...
    @Test
    void updateTest() {
        DigimonTypeModel result =
                service.update(VIRUS_ID, DigimonTypeModel.builder().name(ZOMBIE).build());
        Assertions.assertNotNull(result);
        Assertions.assertEquals(ZOMBIE, result.getName());
    }
    ...
    void patchTest() {
        DigimonTypeModel result =
                service.patch(VIRUS_ID, DigimonTypeModel.builder().name(ZOMBIE).build());
        Assertions.assertNotNull(result);
        Assertions.assertEquals(ZOMBIE, result.getName());
    }
