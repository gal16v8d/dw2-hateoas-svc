...
class AttackTypeServiceIT {
    ...
    @Test
    void updateTest() {
        AttackTypeModel result =
                service.update(INTERRUPT_ID, AttackTypeModel.builder().name(RUN).build());
        Assertions.assertNotNull(result);
        Assertions.assertEquals(RUN, result.getName());
    }
    ...
    void patchTest() {
        AttackTypeModel result =
                service.patch(INTERRUPT_ID, AttackTypeModel.builder().name(RUN).build());
        Assertions.assertNotNull(result);
        Assertions.assertEquals(RUN, result.getName());
    }
    ...
    void patchNoMatchTest() {
        Assertions.assertNull(
                service.patch(ID_NOT_FOUND, AttackTypeModel.builder().name(RUN).build()));
    }
