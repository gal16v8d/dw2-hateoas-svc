...
class DigimonControllerTest {
    ...
    void getAllTest() throws Exception {
        BDDMockito.willReturn(
                ...
                .getAll();
        mvc.perform(
                        MockMvcRequestBuilders.get(V1_DIGIMON)
                ...
                .andExpect(
                        MockMvcResultMatchers.jsonPath("$._embedded.digimonModelList").isArray());
    }
    ...
    void getByIdTest() throws Exception {
        ...
        mvc.perform(
                        MockMvcRequestBuilders.get(V1_DIGIMON_1)
                                .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().contentType(APPLICATION_HAL_JSON))
    ...
    void saveTest() throws Exception {
        ...
        BDDMockito.willReturn(
                        DigimonModel.builder()
                                ...
                                .build())
                .given(digimonService)
                .save(BDDMockito.any(DigimonModel.class));
        mvc.perform(
