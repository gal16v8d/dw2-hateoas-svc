...
class DigimonTypeControllerTest {
  ...
  void getAllTest() throws Exception {
    BDDMockito
        ...
        .given(digimonTypeService).getAll();
    mvc.perform(
        MockMvcRequestBuilders.get(V1_DIGIMON_TYPES).contentType(MediaType.APPLICATION_JSON_VALUE))
        ...
        .andExpect(MockMvcResultMatchers.jsonPath("$._embedded.digimonTypeModelList").isArray());
  }

  @Test
  void getByIdTest() throws Exception {
    BDDMockito.willReturn(DigimonTypeModel.builder().digimonTypeId(1L).name(DATA).build())
        .given(digimonTypeService).getById(BDDMockito.anyLong());
    mvc.perform(MockMvcRequestBuilders.get(V1_DIGIMON_TYPES_1)
  ...
  void saveTest() throws Exception {
    ...
    BDDMockito.willReturn(DigimonTypeModel.builder().digimonTypeId(1L).name(EXTRA).build())
        .given(digimonTypeService).save(BDDMockito.any(DigimonTypeModel.class));
    mvc.perform(MockMvcRequestBuilders.post(V1_DIGIMON_TYPES)
        .contentType(MediaType.APPLICATION_JSON_VALUE).content(MAPPER.writeValueAsString(model)))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andExpect(MockMvcResultMatchers.content().contentType(APPLICATION_HAL_JSON))
  ...
  void updateTest() throws Exception {
    ...
    mvc.perform(MockMvcRequestBuilders.put(V1_DIGIMON_TYPES_1)
        .contentType(MediaType.APPLICATION_JSON_VALUE).content(MAPPER.writeValueAsString(model)))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andExpect(MockMvcResultMatchers.content().contentType(APPLICATION_HAL_JSON))
        .andExpect(MockMvcResultMatchers.jsonPath(JSON_PATH_NAME).value(EXTRA))
  ...
  void updateNotFoundTest() throws Exception {
    DigimonTypeModel model = DigimonTypeModel.builder().name(EXTRA).build();
    BDDMockito.willReturn(null).given(digimonTypeService).update(BDDMockito.anyLong(),
        BDDMockito.any(DigimonTypeModel.class));
    mvc.perform(MockMvcRequestBuilders.put(V1_DIGIMON_TYPES_1)
        .contentType(MediaType.APPLICATION_JSON_VALUE).content(MAPPER.writeValueAsString(model)))
  ...
  void patchTest() throws Exception {
    ...
    mvc.perform(MockMvcRequestBuilders.patch(V1_DIGIMON_TYPES_1)
        .contentType(MediaType.APPLICATION_JSON_VALUE).content(MAPPER.writeValueAsString(model)))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andExpect(MockMvcResultMatchers.content().contentType(APPLICATION_HAL_JSON))
        .andExpect(MockMvcResultMatchers.jsonPath(JSON_PATH_NAME).value(EXTRA))
  ...
  void patchNotFoundTest() throws Exception {
    DigimonTypeModel model = DigimonTypeModel.builder().name(EXTRA).build();
    BDDMockito.willReturn(null).given(digimonTypeService).patch(BDDMockito.anyLong(),
        BDDMockito.any(DigimonTypeModel.class));
    mvc.perform(MockMvcRequestBuilders.patch(V1_DIGIMON_TYPES_1)
        .contentType(MediaType.APPLICATION_JSON_VALUE).content(MAPPER.writeValueAsString(model)))
        .andExpect(MockMvcResultMatchers.status().isNotFound());
  ...
  void deleteTest() throws Exception {
    ...
    mvc.perform(MockMvcRequestBuilders.delete(V1_DIGIMON_TYPES_1)
        .contentType(MediaType.APPLICATION_JSON_VALUE))
