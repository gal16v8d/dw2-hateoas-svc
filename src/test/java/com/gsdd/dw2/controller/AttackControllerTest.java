...
class AttackControllerTest {
  ...
  void saveTest() throws Exception {
    ...
    BDDMockito.willReturn(
            AttackModel.builder().attackTypeId(1L).attackId(1L).mp(16).name(SMILEY_BOMB).build())
        .given(attackService)
        .save(BDDMockito.any(AttackModel.class));
    mvc.perform(
  ...
  void updateTest() throws Exception {
    ...
    BDDMockito.willReturn(
            AttackModel.builder().attackTypeId(1L).attackId(1L).mp(16).name(SMILEY_BOMB).build())
        .given(attackService)
        .update(BDDMockito.anyLong(), BDDMockito.any(AttackModel.class));
    mvc.perform(
  ...
  void patchTest() throws Exception {
    ...
    BDDMockito.willReturn(
            AttackModel.builder().attackTypeId(1L).attackId(1L).mp(16).name(SMILEY_BOMB).build())
        .given(attackService)
        .patch(BDDMockito.anyLong(), BDDMockito.any(AttackModel.class));
    mvc.perform(
