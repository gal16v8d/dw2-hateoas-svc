...
public class DigimonController extends AbstractController<Digimon, DigimonModel> {
  ...
  public DigimonModel defineModelWithLinks(DigimonModel model) {
    ...
    Link levelLink = WebMvcLinkBuilder
        ...
        .withRel("level");
    Link typeLink = WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(DigimonTypeController.class)
        .getById(linkedModel.getDigimonTypeId())).withRel("type");
    Link elementLink = WebMvcLinkBuilder
        .linkTo(
            WebMvcLinkBuilder.methodOn(ElementController.class).getById(linkedModel.getElementId()))
        .withRel("element");
